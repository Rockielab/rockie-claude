...
```bash
python3 .claude/scripts/gpu.py cost --providers datacrunch --json
python3 .claude/scripts/gpu.py list-pods --providers datacrunch
python3 .claude/scripts/gpu.py price 1H100.80S.22V --providers datacrunch
python3 .claude/scripts/gpu.py create --providers datacrunch \
